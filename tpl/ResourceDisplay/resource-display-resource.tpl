        ...
        <div class="card-body p-2">
            <div class="d-flex justify-content-between align-items-center mb-1">
                <small class="text-muted">
                    {format_date date=$reservation->StartDate() key=schedule_daily_time timezone=$Timezone}
                    – {format_date date=$reservation->EndDate() key=schedule_daily_time timezone=$Timezone}
                </small>
