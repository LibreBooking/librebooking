...
class fr_fr extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['DatabaseConnectionError'] = 'Impossible de se connecter au serveur de base de données.<br/>Demandez à l\'administrateur du site de vérifier l\'hôte, le nom d\'utilisateur et le mot de passe de la base de données dans <code>config/config.php</code>.';
        $strings['DatabaseNotFoundError'] = 'Impossible de sélectionner la base de données configurée.<br/>Demandez à l\'administrateur du site de vérifier le nom de la base de données dans <code>config/config.php</code> et de confirmer que la base de données a été créée/initialisée.';
        ...
        $strings['EditReservationHeading'] = 'Éditer la réservation %s';
        ...
        $strings['ScriptUrlNotConfigured'] = 'LibreBooking n\'est pas configuré correctement. Le paramètre <code>script.url</code> est vide, certaines fonctionnalités de l\'application ne fonctionneront donc pas. Veuillez contacter l\'administrateur.';
        ...
        $strings['FirstTimeUser?'] = 'Première visite ?';
        ...
        $strings['YourProfileWasUpdated'] = 'Votre compte a été mis à jour';
        ...
        $strings['MoreResources'] = '+ de ressources';
        ...
        $strings['BlackoutNotUpdated'] = 'La mise hors service n\'a pas pu être mise à jour';
        ...
        $strings['DeleteGroupWarning'] = 'Effacer ce groupe supprimera toutes les permissions de ressources associées. Les utilisateurs concernés pourraient perdre l\'accès à ces ressources.';
        $strings['WhatRolesApplyToThisGroup'] = 'Quels rôles appliquer à ce groupe ?';
        $strings['WhoCanManageThisGroup'] = 'Qui peut gérer ce groupe?';
        $strings['WhoCanManageThisSchedule'] = 'Qui peut gérer cet horaire ?';
        ...
        $strings['True'] = 'Vrai';
        $strings['False'] = 'Faux';
        $strings['ForgotPasswordEmailSent'] = 'Un email a été envoyé à l\'adresse fournie avec les instructions pour réinitialiser votre mot de passe';
        ...
        $strings['ConfigurationUiNotEnabled'] = 'Cette page est inaccessible car $conf[\'settings\'][\'pages\'][\'enable.configuration\'] est égal à false ou manquant.';
        ...
        $strings['DeleteReminderWarning'] = 'Êtes-vous sûr de vouloir supprimer ceci?';
        $strings['NoReminders'] = 'Vous n\'avez pas de prochains rappels';
        ...
        $strings['MakeDefaultSchedule'] = 'Faire de cette page mon planning par défaut';
        ...
        $strings['GetTemplate'] = 'Obtenir le modèle';
        ...
        $strings['CheckIn'] = 'Arrivée';
        $strings['CheckOut'] = 'Départ';
        $strings['ReleasedIn'] = 'Libéré en';
        $strings['CheckedInSuccess'] = 'Arrivée confirmée';
        $strings['CheckedOutSuccess'] = 'Départ confirmé';
        $strings['CheckInFailed'] = 'Arrivée manquée';
        $strings['CheckOutFailed'] = 'Départ manqué';
        ...
        $strings['ReserveLater'] = 'Réserver plus tard';
        ...
        $strings['AutoReleaseMinutes'] = 'Minutes avant libération automatique';
        ...
        $strings['ResourceBufferTimeCsv'] = 'Temps tampon';
        $strings['ResourceMinNoticeAddCsv'] = 'Préavis minimum d\'ajout de réservation';
        $strings['ResourceMinNoticeUpdateCsv'] = 'Préavis minimum de modification de réservation';
        $strings['ResourceMinNoticeDeleteCsv'] = 'Préavis minimum de suppression de réservation';
        ...
        $strings['DeleteMultipleReservationsWarning'] = 'Aucun email ne sera envoyé.';
        $strings['ErrorMovingReservation'] = 'Erreur de déplacement de la réservation';
        $strings['SelectUser'] = 'Sélectionner un utilisateur';
        $strings['InviteUsers'] = 'Inviter des utilisateurs';
        $strings['InviteUsersLabel'] = 'Saisir les adresses email des invités';
        ...
        $strings['NotifyUser'] = 'Notifier l\'utilisateur';
        ...
        $strings['CreditsEachCost2'] = 'Coût de crédit(s)';
        $strings['CreditsCount'] = 'Nombre de crédits';
        ...
        $strings['EachCreditCosts'] = 'Chaque crédit coûte';
        $strings['Checkout'] = 'Paiement';
        $strings['Quantity'] = 'Quantité';
        $strings['CreditPurchase'] = 'Achat de crédit';
        $strings['EmptyCart'] = 'Votre chariot est vide.';
        $strings['BuyCredits'] = 'Acheter des crédits';
        $strings['CreditsPurchased'] = 'crédits achetés.';
        $strings['ViewYourCredits'] = 'Voir vos crédits';
        $strings['TryAgain'] = 'Essayer à nouveau';
        $strings['PurchaseFailed'] = 'Nous avons eu un problème lors du traitement de votre paiement.';
        $strings['NoteCreditsPurchased'] = 'Crédits achetés';
        $strings['CreditsUpdatedLog'] = 'Crédits achetés par %s';
        $strings['ReservationCreatedLog'] = 'Réservation créée. Numéro de référence %s';
        $strings['ReservationUpdatedLog'] = 'Réservation modifiée. Numéro de référence %s';
        $strings['ReservationDeletedLog'] = 'Réservation supprimée. Numéro de référence %s';
        ...
        $strings['Date'] = 'Date';
        $strings['Note'] = 'Note';
        $strings['CreditsBefore'] = 'Crédits avant';
        $strings['CreditsAfter'] = 'Crédits après';
        ...
        $strings['GatewayTransactionDate'] = 'Date de la transaction passerelle';
        $strings['Refund'] = 'Remboursement';
        $strings['IssueRefund'] = 'Émettre un remboursement';
        $strings['RefundIssued'] = 'Remboursement émis avec succès';
        ...
        $strings['Image'] = 'Image';
        $strings['ChooseOrDropFile'] = 'Choisir un fichier ou le déposer ici';
        ...
        $strings['UponReservation'] = 'A la réservation';
        $strings['UponRegistration'] = 'A l\'inscription';
        ...
        $strings['FullAccess'] = 'Accès complet';
        ...
        $strings['PermanentlyPurgeAllDeletedReservations'] = 'Purger définitivement toutes les réservations supprimées';
        $strings['SwitchToACustomLayout'] = 'Changer vers une disposition personnalisée';
        $strings['SwitchToAStandardLayout'] = 'Changer vers une disposition standard';
        $strings['ThisScheduleUsesACustomLayout'] = 'Ce planning utilise une disposition personnalisée';
        $strings['ThisScheduleUsesAStandardLayout'] = 'Ce planning utilise une disposition standard';
        $strings['SwitchLayoutWarning'] = 'Êtes-vous sûr de vouloir changer le type de disposition ? Ceci supprimera tous les créneaux existants.';
        $strings['DeleteThisTimeSlot'] = 'Supprimer ce créneau horaire ?';
        $strings['Refresh'] = 'Rafraîchir';
        $strings['ViewReservation'] = 'Voir la réservation';
        $strings['PublicId'] = 'Id public';
        ...
        $strings['SelectEmailTemplate'] = 'Sélectionner un modèle d\'email';
        ...
        $strings['CurrentReservation'] = 'Réservation actuelle';
        $strings['MissedCheckin'] = 'Arrivée manquée';
        $strings['MissedCheckout'] = 'Départ manqué';
        ...
        $strings['Custom'] = 'Personnalisé';
        $strings['AddDate'] = 'Ajouter une date';
        ...
        $strings['ScheduleMaximumConcurrentNote'] = 'Lorsque ce paramètre est activé, le nombre total de ressources pouvant être réservées simultanément pour cet agenda sera limité.';
        $strings['ScheduleResourcesPerReservationMaximum'] = 'Chaque réservation est limitée à un maximum de <b>%s</b> ressources';
        ...
        $strings['ResourceDisplayInstructions'] = 'Aucune ressource sélectionnée. Vous pouvez trouver l\'URL pour afficher la ressource dans Gestion de l\'Application, Ressources. La ressource doit être en accès public.';
        ...
        $strings['ScanToSchedule'] = 'Scanner pour planifier';
        $strings['MaintenanceNotice'] = 'Maintenance en cours. Nous serons de retour sous peu.';
        $strings['MoreResourceActions'] = 'Plus d\'actions sur la ressource';
        // End Strings
        ...
        $strings['PopulateLargeExampleData'] = 'Importer également un grand jeu de données d\'exemple. Ajoute plus d\'utilisateurs, de ressources, de groupes et de réservations pour des tests réalistes';
        ...
        $strings['StatementFailed'] = 'Échec. Détails :';
        ...
        $strings['ScriptUrlWarning'] = 'Votre paramètre <em>script.url</em> est peut-être incorrect. Il est égal à <strong>%s</strong>, mais nous pensons qu\'il devrait être égal à <strong>%s</strong>';
        // End Install

        // Errors
        $strings['LoginError'] = 'Nom d\'utilisateur ou mot de passe inconnu';
        $strings['LdapConnectionErrorMessage'] = 'Impossible de se connecter au serveur LDAP. Veuillez contacter votre administrateur.';
        $strings['LdapDependencyMissingMessage'] = 'L\'authentification LDAP n\'est pas disponible car pear/net_ldap2 est manquant. Installez-le avec : composer require pear/net_ldap2';
        ...
        $strings['MinNoticeErrorUpdate'] = 'Modifier cette réservation requiert une notification préalable. Les réservations antérieures à %s ne peuvent être modifiées.';
        $strings['MinNoticeErrorDelete'] = 'Supprimer cette réservation requiert une notification préalable. Les réservations antérieures à %s ne peuvent être supprimées';
        ...
        $strings['AccessoryMaxQuantityErrorMessage'] = 'Vous ne pouvez pas réserver plus de %s accessoires %s';
        ...
        $strings['RegisteredAccountRequired'] = 'Seuls les utilisateurs inscrits peuvent effectuer des réservations';
        ...
        $strings['ScheduleTotalReservationsError'] = 'Ce planning autorise uniquement %s ressources simultanées. Cette réservation violerait cette limite aux dates suivantes:';
        $strings['SelfRegistrationDisabled'] = 'Utilisateur non inscrit et auto-inscription est désactivée. Veuillez contacter un administrateur pour créer votre compte.';
        // End Errors

        // Page Titles
        $strings['CreateReservation'] = 'Créer une réservation';
        $strings['EditReservation'] = 'Éditer une réservation';
        ...
        $strings['EditProfile'] = 'Éditer mon profil';
        ...
        $strings['ManageEmailTemplates'] = 'Gérer les modèles d\'email';
        $strings['CheckResources'] = 'Vérifier les ressources';
        $strings['CheckSchedules'] = 'Vérifier les horaires';
        // End Page Titles
        ...
        $strings['ReservationApprovalAdminSubject'] = 'Notification : Une réservation nécessite votre approbation';
        $strings['ParticipantAddedSubject'] = 'Notification de participation à une réservation';
        ...
        $strings['ReservationApprovedSubjectWithResource'] = 'Réservation approuvée pour %s';
        ...
        $strings['NoGroupUpcomingReservations'] = 'Aucun groupe avec une réservation à venir';
        $strings['GroupUpcomingReservations'] = 'Prochaines réservations de mes groupes';
        ...
        $strings['NoMissingCheckOutReservations'] = 'Il n\'y a pas de réservations avec départ manquant';
        $strings['MissingCheckOutReservations'] = 'Réservations avec départ manquant';
        //End Missing Check In/Out Reservations in Dashboard

        //Schedule Resource Permissions
        $strings['NoResourcePermissions'] = 'Impossible de voir les détails de la réservation car vous n\'avez pas les autorisations pour l\'une des ressources dans cette réservation';
        //End Schedule Resource Permissions

        //View Resource
        $strings['Check'] = 'Vérification';
        $strings['PermissionType'] = 'Type d\'autorisation';
        $strings['NoResourcesToView'] = 'Aucune ressource disponible';
        //End View Resource
