...
$conf['settings']['install.password'] = ''; // password for the install user. this is used to access the installation wizard and should be set to a strong password. leave empty to disable the installation wizard
...
$conf['settings']['css.theme'] = 'default'; // default, dimgray, dark_red, dark_green, french_blue, cake_blue, orange
...
// Reservation checkin configuration
$conf['settings']['reservation']['checkin.minutes.prior'] = '5'; // how many minutes before the reservation start time check-in is allowed
...
// Resevation reminders configuration
...
// Reservation label configuration
...
$conf['settings']['registration']['require.phone'] = 'false'; // if phone number is required for registration
$conf['settings']['registration']['require.position'] = 'false'; // if position is required for registration
$conf['settings']['registration']['require.organization'] = 'false'; // if organization is required for registration
...
$conf['settings']['ics']['future.days'] = '30'; // how many days in the future to show in the ical feed
$conf['settings']['ics']['past.days'] = '0'; // how many days in the past to show in the ical feed
...
$conf['settings']['authentication']['allow.keycloak.login'] = 'false';
